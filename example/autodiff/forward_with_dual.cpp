...
int main() {
    ...
    assert(DN<0>(F5)(4.f) == 64.f); //                   F5(    4.f                                )
    assert(DN<1>(F5)(4.f) == 48.f); // D(F5)      (4.f), F5({   4.f,                 {1.f}        }).d[0]
    assert(DN<2>(F5)(4.f) == 24.f); // D(D(F5))   (4.f), F5({  {4.f, {1.f}},         {1.f, {0.f}} }).d[0].d[0]
    assert(DN<3>(F5)(4.f) == 6.f);
    assert(DN<4>(F5)(4.f) == 0.f);
    assert(DN<5>(F5)(4.f) == 0.f);

    // D(F5)      (4.f), F5({   4.f,                 {1.f}        }).d[0]
    // ( 4),{1} * (4),{1} = (16),{ 8}
    // (16),{8} * (4),{1} = (64),{48}

    // D(D(F5))   (4.f), F5({  {4.f, {1.f}},         {1.f, {0.f}} }).d[0].d[0]
    // (( 4),{1}),{(1),{0}} * ((4),{1}),{(1),{0}} = ((16),{ 8}),{( 8),{ 2}}
    // ((16),{8}),{(8),{2}} * ((4),{1}),{(1),{0}} = ((64),{48}),{(48),{24}}
